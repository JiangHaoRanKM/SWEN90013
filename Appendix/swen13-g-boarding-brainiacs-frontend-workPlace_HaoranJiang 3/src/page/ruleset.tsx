  ...
  return (
    <div style={{padding: '20px'}}>
      <div style={{padding: '20px 0px 0px 17px', display: 'flex'}}>
        ...
        />
        <div style={{fontSize: '20px', lineHeight: '28px'}}>Ruleset</div>
      </div>
      <div
        style={{
      ...
      >
        <div>
          <div style={{display: 'flex'}}>
            <div style={{fontSize: '16px'}}>Ruleset</div>
            <div
              style={{
                color: '#B54708',
          ...
          <div style={{color: '#667085'}}>
            Keep track of the different Ruleset.
          </div>
        </div>
        <Button
          icon={<PlusOutlined />}
          ...
          style={{color: 'black'}}
          onClick={() => {
            props.history.push('/app/creatProject');
          }}
        >
          Create Ruleset
        </Button>
